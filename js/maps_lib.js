(function (window, undefined) {
    var MapsLib = function (options) {
        ...
        this.fusionTableId = options.fusionTableId || "1euHNAy9kG1LMiPuvTjgJjOc25qOqIWmYVCCoZEnD",

        // Found at https://console.developers.google.com/
        // Important! this key is for demonstration purposes. please register your own.
        this.googleApiKey = options.googleApiKey || "AIzaSyCH4tXE8IzFXJMJJbPyszK8FzhRt2ewyxc",
        ...
        this.locationScope = options.locationScope || "eldoret";
    ...
    MapsLib.prototype.doSearch = function () {
        ...
        //-----custom filters-----
		var type_column = 'Facilitytype';
		var tempWhereClause = [];
		if ( $("#cbType1").is(':checked')) tempWhereClause.push("Basic primary health care facility");
		if ( $("#cbType2").is(':checked')) tempWhereClause.push("Blood Bank");
		if ( $("#cbType3").is(':checked')) tempWhereClause.push("Comprehensive Teaching &Referral");
		if ( $("#cbType4").is(':checked')) tempWhereClause.push("Dispensaries and clinic-out patient only");
		if ( $("#cbType5").is(':checked')) tempWhereClause.push("Primary care hospitals");
		if ( $("#cbType6").is(':checked')) tempWhereClause.push("Secondary care hospitals");
		if ( $("#cbType7").is(':checked')) tempWhereClause.push("VCT");
    ...
    var self = this;
    var selectColumns = 'Name, Code, Facilitytype, coordinates ';
      ...
      for (var row in data) {
        template = "\
          <div class='row-fluid item-list'>\
            <div class='span12'>\
              <strong><a id='find_me' href='#'>" + data[row][0] + "</a></strong>\
              <br />\
              " + data[row][1] + "\
              <br />\
              " + data[row][2] + "\
